...
class EmployeeModel implements IDataBase
{
    private $dbInstance;
     ...
     *
     * @return Array an associated array with all the employees represented by keys
     */
    public function findAll(): array
    {
        try {
            $query = "SELECT emp_no, apellidos, oficio FROM EMP";
     ...
     *
     * @param  int $id the id of the employee you want to search.
     * @return array
     */
    public function find($id): array
    {
        try {
            $query = "SELECT emp_no, apellidos, oficio, jefe, fecha_alta, salario, comision, dept_no FROM EMP WHERE emp_no = :id";
            $statement = $this->getDbInstance()->prepare($query);
