 ...
 */
final class Version20240126184855 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE persona (id INT AUTO_INCREMENT NOT NULL, imagen VARCHAR(100) NOT NULL, username VARCHAR(50) NOT NULL, password VARCHAR(200) NOT NULL, token VARCHAR(200) NOT NULL, nombres VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
